...
#from playerThree import * 
#from playerFour import * 
#################
...
def timerFired(data):
    ...
    if data.blink == False:
        ...
        data.blink = False 
    if data.mode == "Player One Game":
        playerOneTimerFired(data) 
    elif data.mode == "Player Two Game":
        playerTwoTimerFired(data) 
    elif data.mode == "Player Three Game": 
        playerThreeTimerFired(data) 
    elif data.mode == "Player Four Game":
        playerFourTimerFired(data) 

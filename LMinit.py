...
def dealingHandinit(data): 
    ...
    for i in range (1,15):
        ...
        data.allNames.append(data.playerOneHand)
    ...
    for i in range (1,15): 
        ...
        data.allNames.append(data.playerTwoHand)
    ...
    for i in range(1,15):
        ...
        data.allNames.append(data.playerThreeHand)
        #randomNumber = random.randint(0,len(data.playerImages )-1)
        randomTile = data.objectPics[randomKey] 
    ...
    for i in range (1,15):
        ...
        data.allNames.append(data.playerFourHand)
        #randomNumber = random.randint(0,len(data.playerImages )-1)
        randomTile = data.objectPics[randomKey]  
